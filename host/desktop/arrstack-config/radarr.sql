...
INSERT INTO RootFolders VALUES(1,'/mnt/data/movies');

-- Add default naming config
INSERT INTO NamingConfig VALUES(1,1,'{Movie Title} ({Release Year}) {Quality Full}','{Movie Title} ({Release Year})',4,1);
