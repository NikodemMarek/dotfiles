# to create new export, create a brtfs volume: `btrfs subvolume create <directory>`
{
  services.nfs.server = {
    enable = true;
    exports = ''
      /mnt/data/music          100.0.0.0/8(rw,sync,fsid=1,insecure,no_root_squash,no_subtree_check) 10.42.0.0/16(rw,sync,fsid=1,insecure,no_root_squash,no_subtree_check)
      /mnt/data/movies         100.0.0.0/8(rw,sync,fsid=2,insecure,no_root_squash,no_subtree_check) 10.42.0.0/16(rw,sync,fsid=2,insecure,no_root_squash,no_subtree_check)
      /mnt/data/shows          100.0.0.0/8(rw,sync,fsid=3,insecure,no_root_squash,no_subtree_check) 10.42.0.0/16(rw,sync,fsid=3,insecure,no_root_squash,no_subtree_check)
      /mnt/data/books          100.0.0.0/8(rw,sync,fsid=4,insecure,no_root_squash,no_subtree_check) 10.42.0.0/16(rw,sync,fsid=4,insecure,no_root_squash,no_subtree_check)
